...
import com.github.webapp_minifier.MinifiedFileBuilder;
import com.github.webapp_minifier.MinifiedFileInfo;
...
public class MinifiedFileBuilderTest {
   ...
   public void testConstructorExceptions(final File targetDirectory,
   ...
   public void testMinifiedFileBuilder() {
      ...
      final String extension = "ext";
      final MinifiedFileBuilder builder = new MinifiedFileBuilder(
            targetDirectory, prefix, extension);
      assertTrue("This should indicate a new file", builder.isNewFile());

      final MinifiedFileInfo fileInfo1 = builder.getCurrentFile();
      ...
      final MinifiedFileInfo fileInfo2 = builder.getCurrentFile();
