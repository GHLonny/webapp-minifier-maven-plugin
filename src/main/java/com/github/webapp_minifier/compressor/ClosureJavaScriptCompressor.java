package com.github.webapp_minifier.compressor;
...
/**
 * Basic JavaScript compressor implementation using <a
 * href="http://code.google.com/closure/compiler/">Google Closure Compiler</a> that could be used by
 * {@link HtmlCompressor} for inline JavaScript compression.
 * <p>
 * <b>NOTE:</b> This class has been modified from the original to work with newer versions of the
 * Closure Compiler.
 *
...
public class ClosureJavaScriptCompressor implements Compressor {
   ...
   public ClosureJavaScriptCompressor(final CompilationLevel compilationLevel) {
   ...
   public String compress(final String source) {
      ...
      // prepare source
      final List<SourceFile> input = new ArrayList<SourceFile>();
      ...
      if (this.compilationLevel.equals(CompilationLevel.ADVANCED_OPTIMIZATIONS)) {
         ...
         if (this.externs != null) {
            for (final SourceFile extern : this.externs) {
      ...
      final Result result = compiler.compile(externsList, input, this.compilerOptions);
   ...
   private List<SourceFile> getDefaultExterns() throws IOException {
      final InputStream input = ClosureJavaScriptCompressor.class
            .getResourceAsStream("/externs.zip");
      final ZipInputStream zip = new ZipInputStream(input);
      final List<SourceFile> externs = Lists.newLinkedList();
      for (ZipEntry entry = null; (entry = zip.getNextEntry()) != null;) {
         final InputStream entryStream = ByteStreams.limit(zip, entry.getSize());
   ...
   /**
    * Sets level of optimization that should be applied when compiling JavaScript code. If none is
    * provided, <code>CompilationLevel.SIMPLE_OPTIMIZATIONS</code> will be used by default.
    *
    * <p>
    * <b>Warning:</b> Using <code>CompilationLevel.ADVANCED_OPTIMIZATIONS</code> could break inline
    * JavaScript if externs are not set properly.
    *
    * @param compilationLevel
    *           Optimization level to use, could be set to
    *           <code>CompilationLevel.ADVANCED_OPTIMIZATIONS</code>,
    *           <code>CompilationLevel.SIMPLE_OPTIMIZATIONS</code>,
    *           <code>CompilationLevel.WHITESPACE_ONLY</code>
    *
    * @see <a href="http://code.google.com/closure/compiler/docs/api-tutorial3.html">Advanced
    *      Compilation and Externs</a>
    * @see <a href="http://code.google.com/closure/compiler/docs/compilation_levels.html">Closure
    *      Compiler Compilation Levels</a>
    * @see <a
    *      href="http://closure-compiler.googlecode.com/svn/trunk/javadoc/com/google/javascript/jscomp/CompilationLevel.html">CompilationLevel</a>
    */
   ...
   /**
    * Sets options that will be used by the Closure compiler. If none is provided, default options
    * constructor will be used: <code>new CompilerOptions()</code>.
    *
    ...
    * ones, to use only user defined externs set {@link #setCustomExternsOnly(boolean)
    ...
    */
   public void setExterns(final List<SourceFile> externs) {
    ...
    */
   public void setWarningLevel(final WarningLevel warningLevel) {
      this.warningLevel = warningLevel;
   }

   /**
    * Returns <code>true</code> if default externs defined inside Closure's jar are ignored and only
    * user defined ones are used.
    *
    * @return <code>true</code> if default externs defined inside Closure's jar are ignored and only
    *         user defined ones are used
    */
   ...
   /**
    * If set to <code>true</code>, default externs defined inside Closure's jar will be ignored and
    ...
    * @see #setCompilationLevel(CompilationLevel)
    */
   public void setCustomExternsOnly(final boolean customExternsOnly) {
