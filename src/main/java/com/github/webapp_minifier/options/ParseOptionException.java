...
public class ParseOptionException extends Exception {
    ...
    *           unknown.)
    */
   public ParseOptionException(final String message, final Throwable cause) {
      super(message, cause);
   }
    ...
    *           retrieval by the {@link #getMessage()} method.
    */
   public ParseOptionException(final String message) {
      super(message);
   }
    ...
    *           unknown.)
    */
   public ParseOptionException(final Throwable cause) {
      super(cause);
   }
}
